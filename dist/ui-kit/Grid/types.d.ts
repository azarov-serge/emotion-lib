...
export declare type Justify = keyof typeof JustifyContent;
...
export interface ColProps extends DetailedHTMLProps<HTMLAttributes<HTMLDivElement>, HTMLDivElement> {
