...
import { ValidationStatus } from '../base/InputBase/types';
import { Input } from './Input';
import { Color } from '../../ui-kit/@themes/foodCity/color';
...
export const InputsDemo = () => {
  ...
  const [_, setIsSearchValue2] = useState(false);
  ...
  const searchValue2 = useCallback(() => {
    setIsSearchValue2(true);

    setTimeout(() => {
      setIsSearchValue2(false);
      setResult2(value2);
    }, 1000);
  }, [value2, setResult2, setIsSearchValue2]);
        ...
        <div style={{ flexBasis: '25%', width: '25%', padding: '5px' }}>
          <Input
            ...
            rightButton={{
              ...
              // children: isSearchValue2 ? <Spinner {...spinnerProps} /> : null,
            }}
