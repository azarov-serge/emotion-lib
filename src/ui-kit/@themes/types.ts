...
// #region ProductCard
export type ProductCardWrapperTheme = Record<ProductCardType,{
  bg: string;
  border: string;
}>;
...
export type ProductCardShadowTheme = Record<ProductCardType,{
  color: string;
  bg: string;
}>;

export type ProductCardTextTheme = Record<ProductCardType,{
  color: string;
}>;
